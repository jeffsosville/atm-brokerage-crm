...
export async function classifyEmail(email, routes, { isMarketplace = false } = {}) {
...
{"kind":"buyer_question","route_slug":null,"priority":"high|normal|low","from_name":"sender's name if visible, else null","summary":"one line: who wants what","suggested_action":"one line for John","confidence":0.9}
